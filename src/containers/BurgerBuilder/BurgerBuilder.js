...
class BurgerBuilder extends React.Component {
    ...
    render() {
        ...
        const { purchaseCancelHandler, purchaseContinuedHandler,
            addIngredientHandler, removeIngredientHandler, purchaseHandler } = this
        const { purchasing, ingredients, totalPrice, purchasable
        } = this.state;
